	...
	//to move this into a json file/call, we'll have to change how images are referenced, which I'm too lazy to do.
        const DATA_CONQUEST_TEMPLATE = {
            ...
            crates: [
                ...
                { id: "3", crate_name: "normal_02", description: "Tier 2", mode: "normal", keycards_needed: "120", icon: img_crate_02, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 0, icon: img_shard_commander_ahsoka_tano }] },
                { id: "4", crate_name: "hard_03", description: "Tier 3", mode: "hard", keycards_needed: "155", icon: img_crate_03, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 35, icon: img_shard_commander_ahsoka_tano }, { item_name: "Razor Crest", quantity: 28, icon: img_shard_razor_crest },] },
                { id: "5", crate_name: "normal_03", description: "Tier 3", mode: "normal", keycards_needed: "155", icon: img_crate_03, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 5, icon: img_shard_commander_ahsoka_tano }] },
                { id: "6", crate_name: "hard_04", description: "Tier 4", mode: "hard", keycards_needed: "255", icon: img_crate_04, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 40, icon: img_shard_commander_ahsoka_tano }, { item_name: "Razor Crest", quantity: 32, icon: img_shard_razor_crest },] },
                { id: "7", crate_name: "normal_04", description: "Tier 4", mode: "normal", keycards_needed: "255", icon: img_crate_04, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 10, icon: img_shard_commander_ahsoka_tano }] },
                { id: "8", crate_name: "hard_05", description: "Tier 5", mode: "hard", keycards_needed: "290", icon: img_crate_05, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 50, icon: img_shard_commander_ahsoka_tano }, { item_name: "Razor Crest", quantity: 36, icon: img_shard_razor_crest },] },
                { id: "9", crate_name: "normal_05", description: "Tier 5", mode: "normal", keycards_needed: "290", icon: img_crate_05, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 15, icon: img_shard_commander_ahsoka_tano }] },
                { id: "10", crate_name: "hard_06", description: "Tier 6", mode: "hard", keycards_needed: "360", icon: img_crate_06, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 65, icon: img_shard_commander_ahsoka_tano }, { item_name: "Razor Crest", quantity: 40, icon: img_shard_razor_crest },] },
                { id: "11", crate_name: "normal_06", description: "Tier 6", mode: "normal", keycards_needed: "360", icon: img_crate_06, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 20, icon: img_shard_commander_ahsoka_tano }] },
                { id: "12", crate_name: "hard_07", description: "Tier 7", mode: "hard", keycards_needed: "425", icon: img_crate_07, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 90, icon: img_shard_commander_ahsoka_tano }, { item_name: "Razor Crest", quantity: 44, icon: img_shard_razor_crest },] },
                { id: "13", crate_name: "normal_07", description: "Tier 7", mode: "normal", keycards_needed: "425", icon: img_crate_07, rewards: [{ item_name: "Commander Ahsoka Tano", quantity: 25, icon: img_shard_commander_ahsoka_tano }] },
            ],
            sectors: [
